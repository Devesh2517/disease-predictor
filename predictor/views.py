...
def hospital(request):
    ...
    if searchTerm:
        Hospitals =Hospital_Name.objects.filter(Location__icontains = searchTerm)
    else: 
        Hospitals = Hospital_Name.objects.all()
    return render(request,'hospital.html',{'hospital':True,'active': 'btn btn-success peach-gradient text-white','Hospitals':Hospitals})
