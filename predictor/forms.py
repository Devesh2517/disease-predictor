...
class BreastCancerForm(forms.Form):
    ...
    perimeter = forms.FloatField(label='Mean Perimeter', min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    area = forms.FloatField(label='Mean Area', min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))
...
class DiabetesForm(forms.Form):
    ...
    glucose = forms.FloatField(label='Glucose', min_value=0,  widget=forms.NumberInput(attrs={'class': 'form-control'}))
    bloodpressure = forms.FloatField(label='Blood Pressure', min_value=0,  widget=forms.NumberInput(attrs={'class': 'form-control'}))
    skinthickness = forms.FloatField(label='Skin Thickness', min_value=0,  widget=forms.NumberInput(attrs={'class': 'form-control'}))
    insulin = forms.FloatField(label='Insulin', min_value=0,  widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    sex = forms.RadioSelect(choices=['Male','Female'])

class HeartDiseaseForm(forms.Form):

    age = forms.FloatField(label='Age', min_value=0, max_value=100, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    #drop down for sex
    sex = forms.CheckboxSelectMultiple(choices=['Male','Female'])
   ...
   #sex = forms.FloatField(label='Sex', min_value=0, max_value=100, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    trestbps = forms.FloatField(label='TRESTBPS', min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    chol = forms.FloatField(label='CHOL', min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    thalach = forms.FloatField(label='THALACH', min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))
